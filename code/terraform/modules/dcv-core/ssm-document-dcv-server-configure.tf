...
resource "aws_ssm_document" "ssm_document_dcv_server_configure" {
  name            = "${var.env.prefix}-nice-dcv-server-configure"
  document_type   = "Automation"
  document_format = "YAML"
  target_type     = "/AWS::EC2::Instance"
  content         = <<DOC
description: |
  ## Configure the DCV Server service
schemaVersion: '0.3'
parameters:
  InstanceId:
...
variables:    
  tag:
    ...
    default: 'nice-dcv-server-configure'
mainSteps:
  - name: GetInstance
      ...
      Parameters:
        commands:
          - |
            ...
            ExitWithSuccessMessage 'Completed the NICE DCV Server configuration.'
      ...
      Parameters:
        commands:
          - |
            ...
            ExitWithSuccessMessage 'Completed the NICE DCV Server configuration.' -PrintJson
