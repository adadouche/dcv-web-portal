  ...
  policy = jsonencode(
    {
     ...
     "Statement": [
        ...
        },
        {
          ...
          "Resource": "arn:aws:imagebuilder:${var.env.region}:${var.env.account_id}:image-pipeline/${var.env.prefix}-*",
          "Effect": "Allow"
        },
        {
            "Action": [
          ...
          "Resource": "arn:aws:iam::${var.env.account_id}:role/aws-service-role/imagebuilder.amazonaws.com/AWSServiceRoleForImageBuilder",
          "Effect": "Allow"
        }
     ]
    }
