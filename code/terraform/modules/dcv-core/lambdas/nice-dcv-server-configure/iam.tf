  ...
  policy = jsonencode(
    {
     ...
     "Statement": [
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Resource": [
              "arn:aws:ssm:${var.env.region}:${var.env.account_id}:automation-definition/${var.env.prefix}-nice-dcv-server-*:$DEFAULT"
            ],
        },
        {
            "Action": [
            ...
            "Effect": "Allow",
            "Resource": [
              "arn:aws:ssm:${var.env.region}:${var.env.account_id}:*",
            ],
            "Condition":{
                "StringLike":{
                  "ssm:resourceTag/project":[
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Resource": [
              "arn:aws:ec2:${var.env.region}:${var.env.account_id}:instance/*"
            ],
            "Condition":{
                "StringLike":{
                  "ssm:resourceTag/project":[
        ...
        },   
        {
            ...
            "Effect": "Allow",
            "Resource": [
              "arn:aws:ssm:${var.env.region}::document/*"
            ]       
        },        
     ]
    }
